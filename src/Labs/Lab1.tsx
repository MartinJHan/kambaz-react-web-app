...
tag to tell browsers to render the gaps.
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          ...
          <li>Heat a nonstick pan over medium heat.</li>
          <li>Add a small amount of butter or oil.</li>
          <li>Pour in the eggs.</li>
          <li>Stir gently as they begin to set.</li>
          <li>Remove from heat when still slightly soft.</li>
      ...
      <div id="wd-images">
        ...
        <br />
        <img id="wd-teslabot" src="src/Labs/images/teslabot.jpg" height="200px" />
      </div>
